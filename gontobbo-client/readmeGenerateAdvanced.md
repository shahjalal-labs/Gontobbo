...
| `/login`   | Login page           | No            | Authentication     |
| `/create`  | Create assignment    | Yes           | Protected route    |
| `/update`  | Update assignment    | Yes           | Edit existing item |
...
|------------|-------------|-------------------|---------------------------|---------------|
| `/`        | GET         | Homepage          | `HomePage.jsx`            | No            |
| `/login`   | GET, POST   | Login page        | `LoginPage.jsx`           | No            |
| `/create`  | GET, POST   | Create assignment | `CreateAssignment.jsx`    | Yes           |
| `/update`  | GET, PUT    | Update assignment | `UpdateAssignment.jsx`    | Yes           |
...
|-------------------------------|---------------------------------|-------------------------------------------|-------------------------------|
| `src/pages/HomePage.jsx`       | Homepage UI                     | Displays featured content                  | Entry point for landing page   |
| `src/pages/CreateAssignment.jsx` | Form to create assignments     | Uses `react-hook-form` for validation     | Protected route, authenticated |
| `src/hooks/useAuth.js`          | Authentication hook            | Manages login state                        | Used throughout app            |
| `src/components/NavBar.jsx`     | Navigation bar UI              | Present on all pages                       | Contains links to main routes  |


### Routing & Components Explanation

The app follows RESTful routing conventions with standard HTTP methods like GET, POST, and PUT.
Public routes such as homepage and login require no authentication.
Protected routes like create and update require logged-in users.

UI components correspond to routes and handle the user interface for each page.
Shared components like navigation bars and hooks handle global app behavior such as authentication state.
